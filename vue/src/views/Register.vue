<template>
        <div>
            ...
            <form class="space-y-6" @submit="register">
                <div>
                    ...
                    <div class="mt-2">
                        <input id="fullName" name="text" type="text" autocomplete="fullName" required=""  v-model="user.name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                </div>
                <div>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
       <router-link :to="{name:'Login'}">
           Or
           {{ ' ' }}
           <a href="#" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">login to your account</a>
       </router-link>
      </p>
</template>
